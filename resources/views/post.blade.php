    ...
    <div class="container-fluid" style="background: url(/images/main_page/background.png) no-repeat center center local; background-size: cover;">
        <div class="container p-5">
            ...
            <div class="row p-5 mt-5">
                <div class="col-sm-6 col-md-5 px-5">
                ...
                <div class="col-sm-6 col-md-7 px-lg-5 align-self-stretch position-relative">
                    <div class="row">
                        <h6 class="d-none d-xl-block display-5 text-white fw-bold">
                            {{ $post->title_en }}
                        </h6>
                    </div>
                    <div class="row">
                        <h4 class="d-none d-md-block text-white">
                            Month, Day, Year - Time
                        </h4>
                    </div>
                    <div class="row w-100 d-none d-md-flex position-absolute bottom-0">
                        <div class="col-12">
                            <button class="btn btn-primary btn-lg border-0 rounded-4 w-50" style="background-color: #43aeb6" type="button">
