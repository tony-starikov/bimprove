            ...
            <div class="row pb-5">
                ...
                <div class="col-12 col-md-5 col-lg-9 order-md-3 order-lg-4">
                    ...
                    <div class="row pb-5">
                        ...
                        <div class="col-6 col-md-4 mt-4 px-md-3 ps-lg-0">
                            <a class="btn btn-primary btn-lg border-0 rounded-4 w-100" style="background-color: #34888e" href="{{ route('products') }}" role="button">
                                <span class="fw-bold h4 d-block my-1">REVIT PLUGINS</span>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 mt-4 px-md-3 ps-lg-0">
                            <a class="btn btn-primary btn-lg border-0 rounded-4 w-100" style="background-color: #43aeb6" href="{{ route('families') }}" role="button">
        ...
        <div class="container py-5">
            @foreach($plugins as $plugin)
                <div class="row pb-5 pb-sm-0 py-sm-5 ">
                    <div class="col-sm-6 col-md-5 px-lg-5">
                        <div class="row">
                            <div class="col-5">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a class="btn btn-primary btn-lg border-0 rounded-4 w-75" style="background-color: #6bdcdb" href="#" role="button">
