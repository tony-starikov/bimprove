...
@section('title', 'Dashboard | Create plugin')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('plugins.store') }}">
                    @csrf
                    ...
                    <div class="input-group flex-nowrap mb-3">
                        ...
                        <textarea name="video_url" id="video_url" class="form-control" aria-label="text"></textarea>
                    </div>
