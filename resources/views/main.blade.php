    ...
    <div class="container-fluid" style="background-color: #68d1d3">
        ...
        <div class="container px-xxl-5">
            <div class="row pb-5">
                ...
                <div class="col-12 col-md-7 col-lg-5 col-xl-4 order-md-2">
                    <div class="d-md-none">
                    ...
                    <div class="d-none d-md-block mt-xl-5">
                ...
                <div class="col-12 col-lg-7 col-xl-8 order-md-4 order-lg-3">
...
{{--            </div>--}}
    ...
    <div class="container-fluid d-sm-none" style="background-color: #d4fffb">
        <div class="row pb-5">
            <div class="col-12 px-0">
                <div id="carouselExampleControls6" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        @for ($i = 1; $i < 6; $i++)
                            <div class="carousel-item @if($i == 1) active @endif">
                                <div class="cards-wrapper">
                                    <div class="card border-0 w-100 h-100 px-5 py-2" style="background-color: #d4fffb">
                                        <img src="images/team.png" class="img w-75 mx-auto">
                                        <div class="mt-2 text-center">
                                            <h4 class="fw-bold">Vitaly Vinogradov</h4>
                                            <h4 class="text-dark">
                                                <small>
                                                    Appintment, status
                                                </small>
                    ...
                    <button class="carousel-control-prev" style="width: 30px" type="button" data-bs-target="#carouselExampleControls6" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" style="width: 30px" type="button" data-bs-target="#carouselExampleControls6" data-bs-slide="next">
                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Next</span>
                    </button>
                </div>
    ...
    <div class="container-fluid d-none d-sm-block" style="background-color: #d4fffb">
        <div class="row p-5 pt-0">
            @for($k = 1; $k < 5; $k++)
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="card border-0 h-100" style="background-color: #d4fffb">
                        <div class="text-center mt-3 p-1 " style="max-height: 60%;">
                            <img src="images/team.png" class="img h-100" style="max-width: 100%;" >
                        </div>
