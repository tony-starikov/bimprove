        ...
        <div class="container p-5">
            ...
            <div class="row p-5 my-3 d-flex justify-content-center">
                <div class="col-12 col-md-5 col-lg-3 order-md-3 order-lg-4">
                    <a href="{{ route('contact') }}" role="button" class="btn btn-primary shadow-lg btn-lg border-0 rounded-4 w-100 text-center" style="background-color: #43aeb6">
...
{{--    <div class="container-fluid d-none d-md-block d-lg-none" style="min-height: 100vh;">--}}
...
{{--    <div class="container-fluid d-none d-sm-block d-md-none" style="min-height: 100vh;">--}}
{{--        <div class="container pb-5">--}}
{{--            <div class="row mt-5">--}}
{{--                <div class="col-12">--}}
{{--                    <h1 class="d-none">Bimprove</h1>--}}
...
{{--    <div class="container-fluid d-sm-none" style="min-height: 100vh;">--}}
